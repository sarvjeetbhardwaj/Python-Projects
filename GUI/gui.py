...
mybutton=tkinter.Button(text='Click me',command=button_clicked_2)
mybutton.pack()
...
mybutton=tkinter.Button(text='Click me',command=get_input)
mybutton.pack()
